...
x = df.drop(columns=["score","pid","util_dttm","create_dttm","name","semester_cost_amt","util_flg","subside_rate","semester_cnt","initial_approved_amt","approve_dtm"]) #даты и айдишники. нахуй нам это не надо
y = df["score"]
